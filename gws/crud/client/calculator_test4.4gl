...
FUNCTION play()
    ...
    # Ensure the Edit form field formonly.c value is:-1
    CALL ggc.assertEquals(ggc.getFieldValue("formonly.c"), "-1", SFMT("Field value is not valid, expected: '-1', got: '%1'", ggc.getFieldValue("formonly.c"))) -- INTEGER
